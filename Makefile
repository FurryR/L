...
make_win32 : interpreter.cpp
	$(CXX) $(CXXFLAGS) --static -m32 interpreter.cpp -o lpp_win32.exe
make_win64 : interpreter.cpp
	$(CXX) $(CXXFLAGS) --static-m64 interpreter.cpp -o lpp_win64.exe
...
github : interpreter.cpp
	$(CXX) $(CXXFLAGS) -m32 interpreter.cpp -o lpp_linux32
	$(CXX) $(CXXFLAGS) -m64 interpreter.cpp -o lpp_linux64
	i686-w64-mingw32-g++ $(CXXFLAGS) --static -m32 interpreter.cpp -o lpp_win32.exe
	x86_64-w64-mingw32-g++ $(CXXFLAGS) --static -m64 interpreter.cpp -o lpp_win64.exe
clean :
	@-rm lpp
	@-rm lpp.exe
	@-rm lpp_linux32
